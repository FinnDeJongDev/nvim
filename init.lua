...
require('lazy').setup({
	...
	-- Fuzzy finder
	{
		...
		config = function()
			...
			vim.keymap.set('n', '<leader>sg', require('fzf-lua').grep, { desc = 'fzf grep' })
			...
			vim.keymap.set('n', 'gI', require('fzf-lua').lsp_implementations, { desc = 'lsp implementation' })
...
vim.cmd('highlight Whitespace guifg=#FFF0D9')
